...
export const ArticleList = ({ articles, article_tag }: { articles: Article[], article_tag: string }) => {
  return (
    <div className="flex flex-col gap-2 bg-background w-3/4 mx-auto shadow-md py-4 mt-[-13rem]">
      ...
      <button className="bg-white border-2 text-lg px-4 py-1 font-semibold rounded-md w-40 place-self-center my-4 active:scale-x-[0.98] transition-all duration-300">
        View More
      </button>
    </div>
  );
