...
export const BottomCard = ({ article }: { article: Article }) => {
  ...
  return (
    <Link href={`/article/${article._id}`}>
      <div className="h-full w-full items-center justify-between flex gap-4 px-4 pt-1 sm:flex-row sm:justify-start sm:text-left">
        ...
        <div className="flex-grow sm:pl-8 lg:px-4">
          ...
          <h3 className="text-gray-500 text-sm mb-3">{article.primary_tag}</h3>
